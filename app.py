...
st.markdown("""
    ...
    .card-title { color: #1890ff !important; font-size: 18px; font-weight: bold; margin-bottom: 8px; }
    ...
    .btn-3d:active { transform: translateY(4px); box-shadow: 0 2px 0 rgba(0,0,0,0.4); }
...
# ── GUJARAT ALL DISTRICTS GOVT EMAIL DATABASE ─────────────────────
GOVT_DISTRICT_EMAILS = {
    "મોરબી (Morbi)": {
        "કલેક્ટર કચેરી": "collector-mor@gujarat.gov.in",
        "SDM કચેરી (મોરબી)": "sdm-morbi-raj@gujarat.gov.in",
        "મામલતદાર કચેરી (મોરબી)": "mam-morbi@gujarat.gov.in",
        "DDO કચેરી": "ddo-morbi@gujarat.gov.in"
    },
    "રાજકોટ (Rajkot)": {
        "કલેક્ટર કચેરી": "collector-raj@gujarat.gov.in",
        "SDM કચેરી (રાજકોટ)": "sdm-rajkot@gujarat.gov.in",
        "મામલતદાર કચેરી (રાજકોટ)": "mam-rajkot@gujarat.gov.in",
        "DDO કચેરી": "ddo-raj@gujarat.gov.in"
    },
    "સુરત (Surat)": {
        "કલેક્ટર કચેરી": "collector-sur@gujarat.gov.in",
        "SMC કમિશનર": "commissioner@suratmunicipal.gov.in",
        "SDM કચેરી (સુરત)": "sdm-surat@gujarat.gov.in",
        "મામલતદાર કચેરી (ચોર્યાસી)": "mam-choryasi@gujarat.gov.in"
    },
    "અમદાવાદ (Ahmedabad)": {
        "કલેક્ટર કચેરી": "collector-ahd@gujarat.gov.in",
        "AMC કમિશનર": "mc@ahmedabadcity.gov.in",
        "SDM કચેરી (અમદાવાદ)": "sdm-ahd@gujarat.gov.in"
    },
    "વડોદરા (Vadodara)": {
        "કલેક્ટર કચેરી": "collector-vad@gujarat.gov.in",
        "VMC કમિશનર": "commissioner@vmc.gov.in",
        "SDM કચેરી": "sdm-vadodara@gujarat.gov.in"
    },
    "જામનગર (Jamnagar)": {
        "કલેક્ટર કચેરી": "collector-jam@gujarat.gov.in",
        "SDM કચેરી": "sdm-jamnagar@gujarat.gov.in"
    },
    "જૂનાગઢ (Junagadh)": {
        "કલેક્ટર કચેરી": "collector-jun@gujarat.gov.in",
        "SDM કચેરી": "sdm-junagadh@gujarat.gov.in"
    },
    "ભાવનગર (Bhavnagar)": {
        "કલેક્ટર કચેરી": "collector-bha@gujarat.gov.in",
        "SDM કચેરી": "sdm-bhavnagar@gujarat.gov.in"
    },
    "કચ્છ-ભુજ (Kutch-Bhuj)": {
        "કલેક્ટર કચેરી": "collector-kuch@gujarat.gov.in",
        "SDM કચેરી (ભુજ)": "sdm-bhuj@gujarat.gov.in"
    },
    "અમરેલી (Amreli)": {
        "કલેક્ટર કચેરી": "collector-amr@gujarat.gov.in"
    },
    "આણંદ (Anand)": {
        "કલેક્ટર કચેરી": "collector-and@gujarat.gov.in"
    },
    "બનાસકાંઠા (Banaskantha)": {
        "કલેક્ટર કચેરી": "collector-ban@gujarat.gov.in"
    },
    "ભરૂચ (Bharuch)": {
        "કલેક્ટર કચેરી": "collector-bha@gujarat.gov.in"
    },
    "ગાંધીનગર (Gandhinagar)": {
        "કલેક્ટર કચેરી": "collector-gnr@gujarat.gov.in"
    },
    "મહેસાણા (Mehsana)": {
        "કલેક્ટર કચેરી": "collector-meh@gujarat.gov.in"
    },
    "પાટણ (Patan)": {
        "કલેક્ટર કચેરી": "collector-pat@gujarat.gov.in"
    },
    "પોરબંદર (Porbandar)": {
        "કલેક્ટર કચેરી": "collector-por@gujarat.gov.in"
    },
    "વલસાડ (Valsad)": {
        "કલેક્ટર કચેરી": "collector-val@gujarat.gov.in"
    }
}
...
with st.sidebar:
    ...
    # 📧 સરકારી ઈમેલ સર્ચ ટૂલ (SIDEBAR માં)
    with st.expander("📧 ગુજરાત સરકારી ઈમેલ ડિરેક્ટરી", expanded=True):
        sel_dist = st.selectbox("જિલ્લો પસંદ કરો:", list(GOVT_DISTRICT_EMAILS.keys()))
        if sel_dist:
            offices_dict = GOVT_DISTRICT_EMAILS[sel_dist]
            sel_office = st.selectbox("કચેરી પસંદ કરો:", list(offices_dict.keys()))
            target_email = offices_dict[sel_office]
            st.code(target_email, language="text")
            st.markdown(f"[✉️ ઈમેલ મોકલો (Direct Mail)](mailto:{target_email})")

    # 🔗 મહત્વપૂર્ણ પોર્ટલ લિંક્સ
    with st.expander("🌐 સરકારી પોર્ટલ લિંક્સ"):
        st.link_button("🌐 ગુજરાત લીગલ પોર્ટલ (Blogger)", "https://ramavat12.blogspot.com", use_container_width=True)
