...
# ── HEADER ─────────────────────────────────────────────────────────
st.title("🏛️ સેવા સદન, મહાનગરપાલિકા અને સિવિલ અદાલત ડ્રાફ્ટિંગ સેન્ટર 🏛️")
st.caption("📝 જમીન, મિલકત, ટેક્સ, SMC/AMC અને CPC દીવાની કોર્ટની મુદ્દાસર અરજી ડ્રાફ્ટિંગ સોફ્ટવેર")
st.divider()
