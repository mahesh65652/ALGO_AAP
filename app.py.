"""
app.py — RAMAVAT ALGO [v11.0 - ALL-IN-ONE COMPREHENSIVE INTEGRATION]
========================================================================
"""
...
# ══════════════════════════════════════════════════════════════════
# 🌐 CHARTINK WEBHOOK BACKGROUND RECEIVER (EMBEDDED QUERY LOGIC)
# ══════════════════════════════════════════════════════════════════
...
with col_chart:
    ...
    # 🛠️ ઇન્ડિયન માર્કેટ અને નિફ્ટીના સાચા લાઈવ ચાર્ટ લાવવા માટેનો નવો સુધારો
    if user_symbol in ["NIFTY", "BANKNIFTY", "FINNIFTY"]:
        tv_sym = f"NSE:{user_symbol}1!"  # નિફ્ટી ઇન્ડેક્સ/ફ્યુચર્સ માટે
    else:
        tv_sym = f"NSE:{user_symbol}"    # નોર્મલ ઇન્ડિયન સ્ટોક્સ માટે (દા.ત. SBIN)
