...
# ── DATABASE SETUP ─────────────────────────────────────────────────
DB_FILE = "gram_panchayat_legal_v1.db"
...
# ── 50 APPLICATIONS DATA (FROM IMAGE) ──────────────────────────────
PAN CHAYAT_50_APPS = {
...
# ── HEADER ─────────────────────────────────────────────────────────
st.title("🏛️ ગામ પંચાયત માં આપી શકાય એવી ૫૦ મહત્વની અરજીઓ")
...
with tab1:
    ...
    with col_input:
        ...
        selected_app = st.selectbox("અરજીનો પ્રકાર પસંદ કરો (૫૦ માંથી):", list(PAN CHAYAT_50_APPS.keys()))
        
        # Auto suggest authority based on image list
        suggested_auth = PAN CHAYAT_50_APPS[selected_app]
        ...
        # Generate default body text automatically
