...
# ── CUSTOM CSS (FIXES SELECTBOX, TEXT VISIBILITY & OVERFLOW ISSUES) ─────────────
st.markdown("""
    <style>
    /* Force dark background for the whole page & prevent horizontal scroll */
    .stApp {
    ...
    /* Fix text visibility in headers and subheaders */
    h1, h2, h3, h4, h5, h6, span, label, p {
        color: #ffffff !important;
    }

    /* Fix text inside inputs and textareas */
    ...
    /* ── SELECTBOX (ડ્રોપડાઉન) સંપૂર્ણ સ્ટાઇલ સુધારા ── */
    ...
    /* પસંદ કરેલ હેડર ટેક્સ્ટ (મોટા અને બોલ્ડ) */
    ...
    /* ડ્રોપડાઉનનું પોપઅપ મેનૂ સ્ક્રીનની બહાર ન જાય તે માટે */
    ...
    /* લિસ્ટની અંદરના દરેક ઓપ્શન્સ (સોફ્ટ, મોટા અને ઓવરફ્લો ફિક્સ) */
    div[data-baseweb="menu"] li {
        font-size: 15px !important;
        font-weight: 500 !important;
        color: #ffffff !important;
        padding: 10px 14px !important;
        white-space: normal !important;      /* લખાણ મોટું હોય તો નીચેની લાઈનમાં આવશે */
        word-wrap: break-word !important;     /* અક્ષરો કપાઈ ન જાય તે માટે */
    }

    /* ઓપ્શન પર કર્સર લઈ જતાં (Hover) સોફ્ટ કલર */
