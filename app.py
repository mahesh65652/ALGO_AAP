...
with col_input:
    ...
    applicant_name = st.text_input("અરજદાર / પ્રથમ પક્ષકારનું નામ:", "રમેશભાઈ અમૃતભાઈ પટેલ")
    opposite_party = st.text_input("સામાવાળા / બીજા પક્ષકારનું નામ:", "ગુજરાત રાજ્ય / સુરેશભાઈ શાહ")
