...
# ── PAGE CONFIG ────────────────────────────────────────────────────
st.set_page_config(
    page_title="ગુજરાત હાઇકોર્ટ & મહેસૂલી પોર્ટલ (Complete All-in-One Legal Software)",
    page_icon="⚖️",
    layout="wide"
)
...
# ── SIDEBAR (LOGIN & COMPLETE GOVERNMENT LINKS) ───────────────────
with st.sidebar:
    ...
    st.divider()
    st.header("🗺️ જમીન, ટીપ્પણી અને નકશા પોર્ટલ")
    
    st.link_button(label="🌐 AnyRoR (૭/૧૨, ૮-અ અને ગામ નકશો)", url="https://anyror.gujarat.gov.in/", use_container_width=True)
    st.link_button(label="🏛️ i-ORA (N.A., જમીન માપણી અને ઓનલાઈન રેવન્યુ)", url="https://iora.gujarat.gov.in/", use_container_width=True)
    st.link_button(label="📜 Garvi 2.0 (દસ્તાવેજ અને ઇન્ડેક્સ-૨)", url="https://garvi.gujarat.gov.in/", use_container_width=True)
    st.link_button(label="📑 ઇ-ધરા (૬ નંબરની ફેરફાર નોંધો)", url="https://edhara.gujarat.gov.in/", use_container_width=True)
    st.link_button(label="💳 Cyber Treasury (સ્ટેમ્પ ફી ચૂકવણી)", url="https://www.treasury.gujarat.gov.in/", use_container_width=True)

    st.divider()
    st.header("⚖️ ઈ-કોર્ટ્સ અને અન્ય સરકારી પોર્ટલ")
    st.link_button(label="⚖️ e-Courts India Services", url="https://services.ecourts.gov.in/", use_container_width=True)
    st.link_button(label="🏛️ ગુજરાત હાઇકોર્ટ પોર્ટલ", url="https://gujarathighcourt.nic.in/", use_container_width=True)
    st.link_button(label="📋 Digital Gujarat", url="https://www.digitalgujarat.gov.in", use_container_width=True)
...
# ── HEADER ─────────────────────────────────────────────────────────
st.title("⚖️ ગુજરાત હાઇકોર્ટ & મહેસૂલી લીગલ ડ્રાફ્ટિંગ સોફ્ટવેર (Ultimate Complete)")
st.caption("🔒 પ્રાઇવેટ એક્સેસ | જમીન માપણી, ટીપ્પણી, ૭/૧૨, ૮-અ અને ગુજરાત હાઇકોર્ટના A4 ફોર્મેટિંગ મુજબ")
st.divider()

# ── EXTENDED & COMPLETE DRAFT TEMPLATES ───────────────────────────
TEMPLATES = {
...
with tab1:
    ...
    with col_input:
        ...
        st.link_button("🌐 AnyRoR પરથી ૭/૧૨, ૮-અ કે ગામનો નકશો જુઓ", "https://anyror.gujarat.gov.in/")
        ...
        case_number = st.text_input("કેસ / ખાતા / સર્વે નંબર:", "સર્વે નંબર: ૧૨૩/૧")
...
with tab2:
    ...
    if not st.session_state["logged_in"]:
        ...
        search_q = st.text_input("🔍 જૂના કાગળો શોધો (અરજદારનું નામ, દસ્તાવેજનો પ્રકાર કે સર્વે નંબર લખો):", "")
