...
# ── SIDEBAR LINKS (મહત્વપૂર્ણ લિંક્સ અને કાનૂની પોર્ટલ્સ) ───────────────
with st.sidebar:
    ...
    st.link_button(
        label="🌐 ગુજરાત સરકાર પોર્ટલ", 
        url="https://www.gujaratindia.gov.in", 
        use_container_width=True
    )
    
    st.link_button(
        label="ℹ️ માહિતીનો અધિકાર (RTI)", 
        url="https://www.rtionline.gujarat.gov.in", 
        use_container_width=True
    )
    
    st.link_button(
        label="🏡 ગુજરાત પંચાયત પોર્ટલ", 
        url="https://www.panchayat.gujarat.gov.in", 
        use_container_width=True
    )
    
    st.link_button(
        label="📋 સરકારી યોજના માહિતી (Digital Gujarat)", 
        url="https://www.digitalgujarat.gov.in", 
        use_container_width=True
    )
    
    st.link_button(
        label="📢 ફરિયાદ નિવારણ પોર્ટલ (Grievance)", 
        url="https://www.grievance.gujarat.gov.in", 
        use_container_width=True
    )
...
with col_preview:
    ...
    * ✅ **AnyRoR, Garvi, e-Courts તથા અન્ય ૫ મહત્વની સરકારી પોર્ટલ્સની Direct Links**
    """)
