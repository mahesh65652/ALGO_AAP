...
# ── PAGE CONFIG ────────────────────────────────────────────────────
st.set_page_config(
    page_title="ગુજરાત લીગલ, AMC & સિવિલ સેવા પોર્ટલ",
    page_icon="🏛️",
    layout="wide",
...
# ── HEADER ─────────────────────────────────────────────────────────
st.title("🏛️ સેવા સદન, AMC અને સિવિલ અદાલત ડ્રાફ્ટિંગ સેન્ટર 🏛️")
st.caption("📝 જમીન, મિલકત, ટેક્સ, AMC અને CPC દીવાની કોર્ટની મુદ્દાસર અરજી ડ્રાફ્ટિંગ સોફ્ટવેર")
st.divider()
...
સાહેબશ્રી,
પ્રતિવાદી અદાલતના અધિકારક્ષેત્રમાંથી ભાગી જવાની અને દાવાની રકમની વસુલાતમાં અડચણ ઊભી કરવાની તૈયારીમાં છે. માટે પ્રતિવાદી પાસે યોગ્ય જામીન લેવા અથવા અટકાયત કરવા હુકમ ફરમાવવા વિનંતી છે.
...
with tab1:
    ...
    with col_input:
        ...
        court_name = st.text_input("કચેરી / અદાલતનું નામ:", "શ્રીમાન પ્રિન્સિપાલ સિવિલ જજ સાહેબશ્રીની અદાલત / મામલતદાર કચેરી")
