...
dynamic_pnl = 2500 + (current_time_sec % 10 * 25)
...
# 📈 ડાબી બાજુ: ઇન્ડિયન માર્કેટ ચાર્ટ (ઓટો-ચેન્જિંગ)
with col_chart:
    ...
    <div style="height:450px;">
        <iframe src="https://s.tradingview.com/widgetembed/?symbol={tv_symbol}&interval=5&theme=dark&style=1&timezone=Asia%2FKolkata&locale=in&withdateranges=true" 
...
with col_control:
    # 🔐 બ્રોકર API સેટિંગ્સ (કોઈપણ યુઝર પોતાની કી નાખી શકે તે માટે)
