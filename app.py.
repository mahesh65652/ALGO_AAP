...
st.markdown("""
    ...
    .workflow-title { color: #ffffff; font-size: 18px; font-weight: bold; margin-bottom: 15px; }
    .flow-step {
        background: #091a38;
        border: 1px solid #173b70;
        border-radius: 10px;
    ...
    .arrow-icon { font-size: 24px; color: #1890ff; text-align: center; line-height: 50px; }
...
with st.sidebar:
    ...
    with st.expander("🌐 સરકારી પોર્ટલ લિંક્સ"):
        ...
        st.link_button("📑 GARVI Gujarat (દસ્તાવેજ)", "https://garvigujarat.gov.in/", use_container_width=True)
...
st.markdown("""
    <div class="btn-3d-grid">
        ...
        <a href="https://beneficiary.nha.gov.in/" target="_blank" class="btn-3d btn-orange">🏥 આયુષ્માન ભારત</a>
...
તારીખ: __/__/૨૦૨૬""",
        ...
        "વાહન વીમો / ઇન્સ્યોરન્સ ક્લેમ રજૂઆત":
"""અરજી: વાહન ઇન્સ્યોરન્સ પોલિસી રિન્યુઅલ / થર્ડ પાર્ટી વીમા બાબત.

સાહેબશ્રી,
વાહન નંબર: ____________________ ની ઇન્સ્યોરન્સ પોલિસી રિન્યુઅલ કરવા માટે વાહનની આર.સી. બુક તથા જૂની પોલિસી રજૂ કરેલ છે.
...
તારીખ: __/__/૨૦૨૬""",
    ...
    "🖋️ લીગલ ટાઈપિંગ & સામાન્ય અરજી": {
        "સામાન્ય કચેરી રજૂઆત / અરજી ફોર્મેટ":
"""પ્રતિ,
...
યોગ્ય કાર્યવાહી કરી આપવા નમ્ર વિનંતી છે.
