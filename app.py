...
def get_tradingview_symbol(symbol: str) -> str:
    tv_map = {
        "NIFTY":"TVC:NIFTY","BANKNIFTY":"TVC:BANKNIFTY",
        ...
        "COPPER":"MCX:COPPER1!","ZINC":"MCX:ZINC1!",
        "USDINR":"TVC:USDINR",
    }
...
def trigger_real_order(symbol: str, action: str, qty: int,
    ...
    Angel One (SmartAPI):
        ...
        resp = obj.placeOrder({
            ...
            "ordertype": order_type,     # "MARKET" / "LIMIT" / "STOPLOSS_MARKET"
...
pnl_style = "color:#00c851;" if pnl >= 0 else "color:#ff4444;"
