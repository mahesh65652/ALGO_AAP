...
# ── TEMPLATES ──────────────────────────────────────────────────────
TEMPLATES = {
    "ગુજરાત જમીન પચાવી પાડવા પર (પ્રતિબંધ) અધિનિયમ-૨૦૨૦ કલેક્ટર અરજી":
"""શ્રીમાન અધ્યક્ષશ્રી (જિલ્લા સ્તરીય સમિતિ) અને કલેક્ટર સાહેબશ્રી,
કલેક્ટર કચેરી, ____________

વિષય: ગુજરાત જમીન પચાવી પાડવા પર (પ્રતિબંધ) અધિનિયમ-૨૦૨૦ ની કલમ-૪ અને ૫ હેઠળ કાયદેસરની કાર્યવાહી કરવા બાબત.

અરજદારની વિગત: ____________________________________________________
સામાવાળા (અનધિકૃત કબજો કરનાર) ની વિગત: _____________________________________

જમીન/મિલકતની વિગત:
મોજે ગામ: ____________, તાલુકો: ____________, જિલ્લો: ____________ માં આવેલ સર્વે/બ્લોક નંબર: ____________, ખાતા નંબર: ____________ વાળી જમીન/મિલકત.

સવિનય રજૂઆત નીચે મુજબ છે:

૧. એ કે, ઉપરોક્ત દર્શાવેલ જમીન/મિલકત અરજદારની સ્વતંત્ર/સંયુક્ત માલિકી અને કાયદેસરના હક્ક ભોગવટાની આવેલ છે અને મહેસૂલી રેકોર્ડ (૭/૧૨, ૮-અ, હક્ક પત્રક) પર અરજદારનું નામ નોંધાયેલ છે.

૨. એ કે, સામાવાળા દ્વારા સદર જમીન પર કોઈ પણ જાતના કાયદેસરના હક્ક, હિસ્સા કે માલિકી વગર બળજબરીથી અને અનધિકૃત રીતે ગેરકાયદેસર કબજો જમાવી લેવામાં આવેલ છે / જમીન પચાવી પાડવામાં આવેલ છે (Land Grabbing).

૩. એ કે, અરજદારે સામાવાળાને અવારનવાર શાંતિપૂર્વક સ્વૈચ્છિક રીતે ગેરકાયદેસર કબજો છોડી દેવા રજૂઆત કરવા છતાં સામાવાળા દાદાગીરી કરી ધમકીઓ આપી રહેલ છે અને જમીન ખાલી કરતા નથી.

૪. એ કે, સામાવાળાનું આ કૃત્ય 'ગુજરાત જમીન પચાવી પાડવા પર (પ્રતિબંધ) અધિનિયમ-૨૦૨૦' ની જોગવાઈઓ હેઠળ શિક્ષાપાત્ર ગુનો બને છે.

પ્રાર્થના:
આથી નામદાર કલેક્ટર સાહેબશ્રી તથા જિલ્લા સ્તરીય સમિતિને નમ્ર અરજ છે કે:
(અ) સદર બાબતે ત્વરિત તપાસ કમિટી નીમી સામાવાળા વિરુદ્ધ જમીન પચાવી પાડવા અંગેનો કેસ દાખલ કરવો.
(બ) સદર જમીન પરથી સામાવાળાનો ગેરકાયદેસર કબજો દૂર કરાવી અરજદારને જમીનનો પ્રત્યક્ષ સોંપણી કબજો અપાવવા હુકમ કરવો.
(ક) સામાવાળા વિરુદ્ધ આ અધિનિયમ હેઠળ સત્તાવાર રીતે પોલીસ ફરિયાદ (FIR) દાખલ કરવા હુકમ કરવો.

સાથે સામેલ પુરાવા:
૧. ૭/૧૨, ૮-અ અને ૬ નંબરની હક્ક નોંધોની પ્રમાણિત નકલ.
૨. જમીનનો નકશો / સ્થળ દર્શાવતી વિગતો.
૩. અનધિકૃત કબજા અંગેના પુરાવા/ફોટોગ્રાફ્સ (જો હોય તો).
૪. અરજદારના આધાર કાર્ડની નકલ.
...
૩. મહેનતાણા (ફી) ની શરત: સદર કામગીરી સફળતાપૂર્વક પૂર્ણ થઈ જમીનનું ટાઇટલ ક્લિયર થઈ જાય, ત્યાર બાદ પ્રથમ પક્ષકારે બીજા પક્ષકારને તેમના મહેનત/સેવા બદલ સદર જમીનની નક્કી કરેલ કિંમત અથવા વેચાણ રકમના ૨૫% (પચીસ ટકા) હિસ્સો / રકમ પેટે રૂ. ________/- ચૂકવવાના રહેશે.
...
with tab1:
    ...
    with col_input:
        ...
        # આઈટમ સિલેક્શન મુજબ ડિફોલ્ટ કોર્ટનું નામ
        default_court = "કલેક્ટર કચેરી / જિલ્લા સ્તરીય સમિતિ" if "જમીન પચાવી" in selected_doc else "DILR કચેરી / મામલતદાર કચેરી / ગુજરાત હાઇકોર્ટ"
        court_name = st.text_input("કોર્ટ / કચેરી / ઓથોરિટીનું નામ:", default_court)
        
        c1, c2 = st.columns(2)
        with c1:
            applicant_name = st.text_input("અરજદાર / નાણા આપનારનું નામ:", "મહેશભાઈ વિનોદભાઇ રામાવત")
        with c2:
            opposite_party = st.text_input("સામાવાળા / નાણા લેનારનું નામ:", "સામાવાળાનું નામ (અનધિકૃત કબજો કરનાર)")
            
        case_number = st.text_input("કેસ / નોટિસ / રેકોર્ડ નંબર:", "અરજી સંદર્ભ નંબર: ૨૦૨૬/LGPA/૧૦૧")
        
        st.subheader("📄 કાનૂની લખાણ (ડ્રાફ્ટિંગ)")
        doc_body = st.text_area("મુખ્ય લખાણ (એડિટ કરી શકાય તેવું):", value=TEMPLATES[selected_doc], height=280)
